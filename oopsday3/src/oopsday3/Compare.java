...
public class Compare {
	...
	public static void main(String[] args) {
		...
		boolean result = a==b;   //are they same or are they equal.
		...
		//result = r1 == t1;            // incompatible operand type
		...
		result = r1.equals(r2);        // another way but not applicable for primitives.
		System.out.println(result);     //false
		...
		// we are not comparing objects r1 and t1, instead we are comparing data members of two objects.
